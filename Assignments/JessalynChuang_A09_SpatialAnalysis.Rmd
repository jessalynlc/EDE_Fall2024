...
>ANSWER: The geometry fild appeared, and the dec_long_va and dec_lat_va fields disappeared in the sf dataframe that was created.
>
...
flow_gage_join <-  left_join(gage_sf, flow_data_df, by = c('station_nm' = 'station_nm'))
...
ggplot() + geom_sf(data = counties_transform, color = "black") +
  geom_sf(data = lancaster_sf, color = "red")+
  geom_sf(data = lancaster_gage, color = "orange") +
