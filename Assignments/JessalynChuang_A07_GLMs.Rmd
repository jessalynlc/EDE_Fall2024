...
temperaturebydepth <- 
  ...
  ylim(0, 35) +
  geom_point() +
  labs(x = "Depth", y = "Temperature [C]", title = "Temperature by Depth in July") +
...
> Answer: The AIC method suggested to use all three variables, year4, daynum, and depth, to predict temperature in our multiple regression. This model explains 74.12% of the variance, which is a slight imporvement over the model using only depth as the explanatory variable.
