...
> Answer: Ifelse is vectorized, which means that the function is capable of evaluating each element of a vector and returning a vectorized output ("R ifelse() Function," n.d.). If...else is not vectorized, and therefore is expecting a single value and will return an error. 
