...
> Answer: Besides species categorized as "Other", the top six most commonly 
studied include: (1) Honey Bee (2) Parasitic Wasp (3) Buff Tailed Bumblebee 
(4) Carniolan Honey Bee (5) Bumble Bee (6) Italian Honeybee. Honey bees, bumble 
bees, and their subspecies are pollinators. All of these species are pollinators 
and might be of interest over other insects because they are crucial to crop 
pollinaton, and as a result, global food production. They are also important 
indicators of ecosystem health. The decline of these species may have 
...
> Answer: The boxplot is more effective here because the actual amount of values
in each functionalGroup is small, and since the width is proportional to the
amount of values, the width will also be small for each functionalGroup in the
violin plot.
