...
2. Web services: URLs, "REST", and APIs (application program interface)
...
df <- data.frame("State" = the_states,
                 ...
                 "Net Summer Capacity (MW)" = as.numeric(gsub(",","",the_capacity)),
                 "Net Generation (MWh)" = as.numeric(gsub(",","",net_generation)),
                 "Total retail sailes (MWh)" = as.numeric(gsub(",","",total_retail)))

df <- filter(df, State != "U.S. Total")
```
