...
#subset function does something similar to filtering, takes original data, replaces it with new data
...
### rbind
Rbind stands for row bind. Combining datasets by row
...
#use a pipe, and for this object LitterFiles, read each element in file using read.csv file If we do that
Litter <- LitterFiles %>%
  plyr::ldply(read.csv)
```
