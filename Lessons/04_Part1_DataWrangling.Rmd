...
#152 is the first day of June that we want to include
NTL.phys.data.JunethruOctober1 <- filter(NTL.phys.data, daynum > 151 & daynum < 305)
#The comma is interpreted as combination of both
...
```{r selecting columns}
#Pulling a subset of dataframe that just has sample date, depth, and temp
...
#From the data set, take lakeid:daynum, month column, then the rest
