...
#Alternative 1, if you add the L, it'll make it an integer. L is short for long integer, meaning it can
#store a long integer. There is also a short integer that only goes til 255, deals with computer
#numbers.
