...
Nutrientplot3 <-
  ...
  geom_boxplot(aes(color = nutrient)) # Why didn't we use "fill"? keeping contour black but changing fill of box plot, doesn't look that nice. So use color for box plots
print(Nutrientplot3)
