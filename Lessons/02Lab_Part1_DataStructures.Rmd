...
#concatenates vector4 to vector1
c(vector1, vector4)

#vector multiplication
vector1 * vector4

#multiple every value in vector1 by 10
vector1 * 10

#changes lowercase letters to upper canse letters
toupper(vector2) 

# negates values in vector3
!vector3
...
matrix1[4,  ] #entire row 4

matrix1[ , 3] #just column 3
