...
my_plot <- nutrient_data %>% 
  ...
  scale_x_date(
    date_breaks = "1 years",
    date_labels = '%Y') +
  scale_shape_manual(values = c(17, 15)) + #17 is a triangle, 15 is a square
  labs(
...
my_plot <- nutrient_data %>% 
  ...
  ggplot(aes(
    x = sampledate,
    #y = the_parameter, this will not work because ggplot is looking for a column called the_parameter and doesn't know what it's pointing to
